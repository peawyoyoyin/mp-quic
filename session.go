...
var newClientSession = func(
	...
	// fmt.Printf("AT NEWCLIENTSESSION FixedNumberPaths: %d\n", s.config.FixedNumberPaths)
...
func (s *session) setup(
	...
	// fmt.Printf("AT SESSION SETUP FixedNumberPaths: %d\n", s.config.FixedNumberPaths)
...
func (s *session) run() error {
	...
	// fmt.Printf("AT SESSION FixedNumberPaths: %d\n", s.config.FixedNumberPaths)
